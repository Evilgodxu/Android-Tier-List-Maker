...
object BitmapToYuvConverter {
    ...
    /**
     * 将 ARGB Bitmap 转换为 YUV420SemiPlanar（NV12）字节数组
     */
    fun argbToNv12(bitmap: Bitmap): ByteArray {
        val width = bitmap.width
        val height = bitmap.height
        val ySize = width * height
        val uvSize = ySize / 4
    ...
    private fun rgbToYuv(pixel: Int): Triple<Int, Int, Int> {
